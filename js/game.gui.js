...
btn_no = new Button(100, 100, 42, 41, "NO");
btn_no.SetImage(0, GameSprites.btn_no);
buttons['btn_no'] = btn_no;

btn_ok = new Button(100, 100, 42, 41, "OK");
btn_ok.SetImage(0, GameSprites.btn_ok);
buttons['btn_ok'] = btn_ok;

btn_back_to_game = new Button(100,100,135,56,"Back To Game");
btn_back_to_game.SetImage(0, GameSprites.btn_back_to_game);
buttons['btn_back_to_game'] = btn_back_to_game;

btn_option = new Button(100,100,135,56,"Options");
btn_option.SetImage(0, GameSprites.btn_option);
buttons['btn_option'] = btn_option;

btn_exit = new Button(100,100,135,56,"Exit Game");
btn_exit.SetImage(0, GameSprites.btn_exit);
buttons['btn_exit'] = btn_exit;
