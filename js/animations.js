...
*/
	...
	anim_blood_up = new AnimationClass('blood_up', GameSprites.blood_up, 1, 6, 1, 5, 32, 32, 6 / 30);
	anim_blood_down = new AnimationClass('blood_down', GameSprites.blood_down, 1, 6, 1, 5, 32, 32, 6 / 30);
	anim_blood_left = new AnimationClass('blood_left', GameSprites.blood_left, 1, 6, 1, 5, 32, 32, 6 / 30);
	anim_blood_right = new AnimationClass('blood_right', GameSprites.blood_right, 1, 6, 1, 5, 32, 32, 6/ 30);
