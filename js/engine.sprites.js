...
var GameSprites = {
    ...
    */
	...
	blood_up : new Image(),
	blood_down : new Image(),
	blood_left : new Image(),
	blood_right : new Image(),
	btn_exit  : new Image(),
	btn_menu : new Image(),
...
GameSprites.blood_up.src = config.IMAGES_PATH + 'Blood_up.png'; 
GameSprites.blood_down.src = config.IMAGES_PATH + 'Blood_down.png';
GameSprites.blood_left.src = config.IMAGES_PATH + 'Blood_left.png';
GameSprites.blood_right.src = config.IMAGES_PATH + 'Blood_right.png'; //35

GameSprites.btn_exit.src = config.IMAGES_PATH + 'btn_exit.png'; 
GameSprites.btn_menu.src = config.IMAGES_PATH + 'btn_menu.png';
GameSprites.btn_option.src = config.IMAGES_PATH + 'btn_option.png';
GameSprites.btn_no.src = config.IMAGES_PATH + 'btn_no.png'; 
GameSprites.btn_back_to_game.src = config.IMAGES_PATH + 'btn_back_to_game.png'; //40
}
