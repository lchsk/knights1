...
<?php
    function game()
    {
        ...
        $files = array(
        // Libraries
            'lib/jquery.js', 'lib/messi.min.js','menu.js',	'lib/jquery-ui.js', 
            'lib/json2.js',
		...
		$html .= '<link type="text/css" rel="stylesheet" href="' . $config->HOST . 'css/jquery-ui.css' . '"/>';
		$html .= '<link type="text/css" rel="stylesheet" href="' . $config->HOST . 'css/styles.css' . '"/><link type="text/css" rel="stylesheet" href="' . $config->JS_FILES_PATH . 'lib/messi.css"/></head><body>';
		$html .= '<div id="title" class="naglowek"></div>';
		$html .= '<div id="centers"><div id="game_div" class="gameBox left">';
		...
		<div id="menu" class="menu">
			<a onclick="menu();"><img src="images/btn_menu.png" title="Menu"/>
				
			</a>
		</div>
	</div>
	<div id="foot" class="naglowek">
	</div>';
